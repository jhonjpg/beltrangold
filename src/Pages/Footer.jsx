...
<footer className="w-full p-1 h-60 overflow-hidden ">

<ul className="w-full h-full flex items-center justify-center flex-wrap gap-0">

    <li className="w-2/4 h-2/4 md:w-1/4  rounded-full overflow-hidden scale-150">  <img className="w-full h-full object-contain" src="/bc.jpg" alt="" /></li>
...
<p className="text-gray-500">809-343-3323</p>
<p className="text-gray-500">beltranje@gmail.com</p>
...
<div className="socialNet">
  ...
  <a href="https://github.com/jhonjpg/" className="socialContainer containerTwo"target="_blank" >
    ...
    <a href="www.linkedin.com/in/jonathanjpg" className="socialContainer containerThree" target="_blank">
